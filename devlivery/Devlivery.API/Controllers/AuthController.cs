...
namespace Devlivery.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private readonly IConfiguration _config;
            ...
            public async Task<IActionResult> AtualizarPerfil([FromBody] AlterarPerfilModel perfilAtualizado)
            {
                var resultado = await _usuarioService.AtualizarPerfil(perfilAtualizado);
